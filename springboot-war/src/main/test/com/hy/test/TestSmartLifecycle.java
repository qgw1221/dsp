...
public class TestSmartLifecycle implements SmartLifecycle {
    ...
    private final  static Logger logger = LoggerFactory.getLogger(TestSmartLifecycle.class); 
    ...
    public void start() {
    	//读取自定义参数
    	System.out.println(" this  the author is :"  +author);
    	logger.error("哈哈======logback  start======");
